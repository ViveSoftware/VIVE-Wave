...
namespace Wave.Essence.Samples.ButtonTest
{
	...
	public sealed class DemoButtonGazeInput : PointerInputModule
	{
		...
		private DemoButtonGazePointer gazePointer = null;
		...
		protected override void OnEnable()
		{
			if (!mEnabled)
			{
				...
				if (head != null)
				{
					gazePointer = head.GetComponentInChildren<DemoButtonGazePointer>();
					if (gazePointer == null)
					{
						...
						gazePointer = pointer_object.AddComponent<DemoButtonGazePointer>();
